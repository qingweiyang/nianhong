...
<ul id="saler-task-tab" class="nav nav-tabs" role="tablist">
  <li role="presentation"><a href="javascript:changeTab(0)">待审核</a></li>
  <li role="presentation"><a href="javascript:changeTab(1)">任务中</a></li>
  <li role="presentation" class="active"><a href="javascript:changeTab(2)">已完成</a></li>
  <li role="presentation"><a href="javascript:changeTab(3)">交易失败</a></li>
</ul>
