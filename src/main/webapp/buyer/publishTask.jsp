...
<form class="form-horizontal" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <label class="radio-inline">
        <input type="radio" name="inlineRadioOptions1" id="verifyRadio1" value="option1" checked> 是
      </label>
      <label class="radio-inline">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <label class="radio-inline">
        <input type="radio" name="inlineRadioOptions2" id="verifyRadio1" value="option1" checked> 是
      </label>
      <label class="radio-inline">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2">
      <label class="radio-inline">
        <input type="radio" name="inlineRadioOptions3" id="tmo" value="option1" checked> 是
      </label>
      <label class="radio-inline">
